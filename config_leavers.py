...
Whenever the respondent mentions an abstract reason, immediately unpack meaning by anchoring it in a concrete moment, comparison, or constraint rather than continuing with increasingly abstract probes.
...
Collect concrete evidence when helpful by asking for concrete moments, information they used, conversations they had, or steps they considered taking.
...
This part elicits thresholds and margins. It must not be framed as removing entrepreneurship risk, since some concerns may be intrinsic.
...
Then ask up to four questions that clarify what comfortable meant in their terms, without suggesting examples.
Focus on identifying thresholds rather than hypothetical ideals.
If a respondent mentions an extreme or unrealistic counterfactual, interpret it as a signal of a binding constraint and clarify whether this constraint was continuous or a strict deal breaker.
Focus on:
...
What would have been the first practical sign that proceeding was worth it
...
DISPLAY_BOLD_PHRASES = [
    "Could you walk me through what led you to decide not to go ahead?",
]
